...
|`authentication.type`
|The authentication methods to be used: `none`, `basic`, `kerberos`, `custom`, `bearer`.
More information link:https://neo4j.com/docs/java-manual/4.4/client-applications/#java-driver-authentication[here, window=_blank]
|`basic`
|No
